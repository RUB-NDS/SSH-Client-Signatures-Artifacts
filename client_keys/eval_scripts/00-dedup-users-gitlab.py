#!/usr/bin/env python3
#
# Usage: ./00-dedup-users-gitlab.py
#
# Helper script to remove duplicate GitLab entries in Elasticsearch based on their username.
...
SRC_INDEX=INDEX_USERS_GITLAB
DEST_INDEX=INDEX_USERS_GITLAB + "_dedup"
MAPPINGS={
  "properties": {
      "deleted": {
        "type": "boolean"
