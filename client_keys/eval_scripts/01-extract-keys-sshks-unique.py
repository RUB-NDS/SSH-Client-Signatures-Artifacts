...
INDEX_USERS_LAUNCHPAD = "sshks_keys_launchpad_202501"
INDEX_USERS_GITLAB = "sshks_keys_gitlab_202501"
INDEX_USERS_GITHUB = "sshks_keys_github_202501"
SRC_INDICES = [INDEX_USERS_GITHUB, INDEX_USERS_GITLAB, INDEX_USERS_LAUNCHPAD]
DEST_INDEX = "sshks_keys_unique_202501"
MAPPINGS = {
    "properties": {
        "entry": {"type": "integer"},
        "alg": {"type": "keyword"},
...
class KeyIterator(object):
    def __init__(self, batchsize=5000, request_timeout=60, scroll="60m", bulk_threads=16):
...
if __name__ == "__main__":
    with KeyIterator(batchsize=100000) as iterator:
        iterator.run()
