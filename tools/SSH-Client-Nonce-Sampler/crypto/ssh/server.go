...
type ServerConfig struct {
	...
	PublicKeySignatureCallback func(conn ConnMetadata, key PublicKey, signedData []byte, sig *Signature) error
	...
	for {
		...
		case "publickey":
			...
			if isQuery {
				...
				err := config.PublicKeySignatureCallback(s, pubKey, signedData, sig)
				if err != nil {
					authErr = err
					break
				}
